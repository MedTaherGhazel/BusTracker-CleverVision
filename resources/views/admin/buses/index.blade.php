            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="rounded-t mb-0 px-4 py-3 border-0">
                        <div class="flex flex-wrap items-center static ...">
                            <div
                                class="inline-block block max-w-md rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] ">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div class="relative mb-6" data-te-input-wrapper-init>
                                            ...
                                            <input type="text"
                                                ...
                                                id="reg_num"~ name="reg_num" required />
                                        </div>
                            ...
                            {{-- Show all bus form --}}
                            <div
                                class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded inline-block ">
